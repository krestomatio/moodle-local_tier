 ...
 */
class total_registered_users_task extends \core\task\scheduled_task {
    ...
    public function get_name() {
        return new \core\lang_string('totalregistereduserstaskname', 'local_tier');
    }
    ...
    public function execute() {
        \local_tier\tier::set_total_registered_users();
    }
}
